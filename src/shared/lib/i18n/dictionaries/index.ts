...
import {
	languageDropdownTranslations as languageDropdownTranslationsImpl,
...
import {
	footerTranslations as footerTranslationsImpl,
	headerLogoTranslations as headerLogoTranslationsImpl,
	headerNavigationTranslations as headerNavigationTranslationsImpl,
	mainNavigationTranslations as mainNavigationTranslationsImpl,
	mobileMenuButtonTranslations as mobileMenuButtonTranslationsImpl,
	mobileMenuTranslations as mobileMenuTranslationsImpl,
	settingsLabelTranslations as settingsLabelTranslationsImpl
} from './layout'
...
export const footerTranslations = footerTranslationsImpl
export const headerLogoTranslations = headerLogoTranslationsImpl
export const headerNavigationTranslations = headerNavigationTranslationsImpl
export const homePageTranslations = homePageTranslationsImpl
export const jsonViewTranslations = jsonViewTranslationsImpl
export const languageDropdownTranslations = languageDropdownTranslationsImpl
...
export const mainNavigationTranslations = mainNavigationTranslationsImpl
export const mobileMenuButtonTranslations = mobileMenuButtonTranslationsImpl
export const mobileMenuTranslations = mobileMenuTranslationsImpl
...
export type FooterTranslationKey = import('./layout').FooterTranslationKey
export type HeaderLogoTranslationKey =
	import('./layout').HeaderLogoTranslationKey
export type HeaderNavigationTranslationKey =
	import('./layout').HeaderNavigationTranslationKey
...
export type LanguageDropdownTranslationKey =
	import('./language').LanguageDropdownTranslationKey
...
export type MainNavigationTranslationKey =
	import('./layout').MainNavigationTranslationKey
export type MobileMenuButtonTranslationKey =
	import('./layout').MobileMenuButtonTranslationKey
export type MobileMenuTranslationKey =
	import('./layout').MobileMenuTranslationKey
