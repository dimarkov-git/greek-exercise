...
import verbsBeJson from '../../src/app/test/msw/data/exercises/verbs-be.json' with {
	type: 'json'
}

import verbsHaveJson from '../../src/app/test/msw/data/exercises/verbs-have.json' with {
	type: 'json'
}
